...
class WhatsNewFragment : BaseFragment() {
    ...
    private fun performConfirmAction(navigationState: NavigationState) {
        when (navigationState) {
            ...
            NavigationState.SlumberStudiosRedeemPromoCode -> slumberStudiosRedeemPromoCode()
        }
    }
    ...
    private fun slumberStudiosRedeemPromoCode() {
        openUrl(Settings.SLUMBER_STUDIOS_REDEEM_PROMO_URL)
    }
