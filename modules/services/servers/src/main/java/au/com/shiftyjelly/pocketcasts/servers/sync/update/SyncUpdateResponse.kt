...
data class SyncUpdateResponse(
    ...
    data class EpisodeSync(
        ...
        companion object {
            fun fromSyncUserEpisodeSync(syncUserEpisode: SyncUserEpisode): EpisodeSync =
                EpisodeSync(
...
private fun syncUserPlaylistToPlaylist(syncUserPlaylist: SyncUserPlaylist): Playlist =
    Playlist(
        uuid = syncUserPlaylist.originalUuid, // it's important to use this field, not uuid because the server won't change the case on this one
