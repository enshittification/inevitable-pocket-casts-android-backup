...
interface PodcastManager {
    ...
    suspend fun refreshPodcasts(podcasts: List<Podcast>, playbackManager: PlaybackManager, refreshResponse: RefreshResponse)
    suspend fun refreshPodcast(existingPodcast: Podcast, playbackManager: PlaybackManager, response: Response<PodcastResponse>): List<PodcastEpisode>
