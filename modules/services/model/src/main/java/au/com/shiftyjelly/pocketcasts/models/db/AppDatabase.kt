...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_78_79 = addMigration(78, 79) { database ->
            database.execSQL("CREATE TABLE `podcast_episodes_copy_table` (`uuid` TEXT NOT NULL, `episode_description` TEXT NOT NULL, `published_date` INTEGER, `title` TEXT NOT NULL, `size_in_bytes` INTEGER NOT NULL, `episode_status` INTEGER NOT NULL, `file_type` TEXT, `duration` REAL NOT NULL, `download_url` TEXT, `downloaded_file_path` TEXT, `downloaded_error_details` TEXT, `play_error_details` TEXT, `played_up_to` REAL NOT NULL, `playing_status` INTEGER NOT NULL, `podcast_id` TEXT NOT NULL, `added_date` INTEGER NOT NULL, `auto_download_status` INTEGER NOT NULL, `starred` INTEGER NOT NULL, `thumbnail_status` INTEGER NOT NULL, `last_download_attempt_date` INTEGER, `playing_status_modified` INTEGER, `played_up_to_modified` INTEGER, `duration_modified` INTEGER, `starred_modified` INTEGER, `archived` INTEGER NOT NULL, `archived_modified` INTEGER, `season` INTEGER, `number` INTEGER, `type` TEXT, `cleanTitle` TEXT, `last_playback_interaction_date` INTEGER, `last_playback_interaction_sync_status` INTEGER NOT NULL, `exclude_from_episode_limit` INTEGER NOT NULL, `download_task_id` TEXT, `last_archive_interaction_date` INTEGER, PRIMARY KEY(`uuid`))")
            database.execSQL("INSERT INTO `podcast_episodes_copy_table` (`uuid`, `episode_description`, `published_date`, `title`, `size_in_bytes`, `episode_status`, `file_type`, `duration`, `download_url`, `downloaded_file_path`, `downloaded_error_details`, `play_error_details`, `played_up_to`, `playing_status`, `podcast_id`, `added_date`, `auto_download_status`, `starred`, `thumbnail_status`, `last_download_attempt_date`, `playing_status_modified`, `played_up_to_modified`, `duration_modified`, `starred_modified`, `archived`, `archived_modified`, `season`, `number`, `type`, `cleanTitle`, `last_playback_interaction_date`, `last_playback_interaction_sync_status`, `exclude_from_episode_limit`, `download_task_id`, `last_archive_interaction_date`) " +
                    "SELECT `uuid`, `episode_description`, `published_date`, `title`, `size_in_bytes`, `episode_status`, `file_type`, `duration`, `download_url`, `downloaded_file_path`, `downloaded_error_details`, `play_error_details`, `played_up_to`, `playing_status`, `podcast_id`, `added_date`, `auto_download_status`, `starred`, `thumbnail_status`, `last_download_attempt_date`, `playing_status_modified`, `played_up_to_modified`, `duration_modified`, `starred_modified`, `archived`, `archived_modified`, `season`, `number`, `type`, `cleanTitle`, `last_playback_interaction_date`, `last_playback_interaction_sync_status`, `exclude_from_episode_limit`, `download_task_id`, `last_archive_interaction_date` " +
                    "FROM `podcast_episodes`")
            database.execSQL("DROP TABLE `podcast_episodes`")
            database.execSQL("ALTER TABLE `podcast_episodes_copy_table` RENAME TO `podcast_episodes`")
        }
